...
export default class MyPlugin extends Plugin {
	...
	async onload() {
		...
		const VIEW_TYPE = 'ollamark-sidebar';
		
		this.registerView(
			VIEW_TYPE,
			(leaf) => new (require('./ui/sidebar').OllamarkSidebarView)(leaf)
		);
	...
	onunload() {
		// Detach all sidebar views when plugin is unloaded
		this.app.workspace.getLeavesOfType('ollamark-sidebar').forEach(leaf => leaf.detach());
	}
